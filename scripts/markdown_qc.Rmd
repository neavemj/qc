...
subtypes <- subtypes %>%
  mutate("expected_length" = case_when(
    startsWith(Reference_Name, "A_HA") ~ 1800,
    startsWith(Reference_Name, "A_MP") ~ 1000,
    startsWith(Reference_Name, "A_NA") ~ 1500,
    startsWith(Reference_Name, "A_NP") ~ 1600,
    startsWith(Reference_Name, "A_NS") ~ 900,
    startsWith(Reference_Name, "A_PA") ~ 2200,
    startsWith(Reference_Name, "A_PB1") ~ 2400,
    startsWith(Reference_Name, "A_PB2") ~ 2400
  ))
...
# config_lines <- readLines("../../test2_H5_singleSample/config.yaml")
